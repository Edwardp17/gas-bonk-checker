...
async function main(address, startDt, endDt, coin) {
    ...
    if (startDate >= endDate) {
        return {
            invalid_request: "start date cannot be equal to or after end date",
        };
    }
    ...
    return `You spent ${totalTxnFeeEth} ETH or $${totalTxnFeeUsd} USD on ${potentialCoinsDict.length}, ETH transaction(s). Meanwhile, you could have bought ${potentialCoins} BONK which today would be worth..........$${potentialCoinsUsd} USD. cope.`;
}
